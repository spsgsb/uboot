...
extern int aml_lcd_extern_mipi_st7701_wily_probe(struct aml_lcd_extern_driver_s *ext_drv);
extern int aml_lcd_extern_mipi_st7701_holitech_probe(struct aml_lcd_extern_driver_s *ext_drv);
#endif
...
extern int aml_lcd_extern_mipi_ILI9806E_probe(struct aml_lcd_extern_driver_s *ext_drv);
#endif
