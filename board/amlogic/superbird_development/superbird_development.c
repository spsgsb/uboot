...
/*
 * board/amlogic/superbird_development/superbird_development.c
 *
...
int board_late_init(void)
{
    ...
    if (strcmp(getenv("panel_type"), pt)) {
...
int checkhw(char * name)
{
	...
	if (MESON_CPU_MAJOR_ID_SM1 == cpu_id.family_id) {
		...
		switch (ddr_size) {
			case 0x80000000:
				strcpy(loc_name, "g12a_evt_2g\0");
				break;
			case 0x40000000:
				strcpy(loc_name, "g12a_evt_1g\0");
				break;
			case 0x2000000:
				strcpy(loc_name, "g12a_evt_512m\0");
				break;
			default:
				strcpy(loc_name, "g12a_evt_unsupport");
				break;
		}
	}
