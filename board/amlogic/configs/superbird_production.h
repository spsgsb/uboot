...
#ifndef __SUPERBIRD_PRODUCTION_H__
#define __SUPERBIRD_PRODUCTION_H__
...
#define CONFIG_EXTRA_ENV_SETTINGS \
        ...
        "avb2=1\0"\
        "initargs="\
            "init=/sbin/pre-init ramoops.pstore_en=1 ramoops.record_size=0x8000 ramoops.console_size=0x4000 rootfstype=ext4"\
            "\0"\
        "storeargs="\
...
#define CONFIG_BOOTDELAY	-2 //delay 1s
